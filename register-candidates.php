...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-mini"><b>J</b>RS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>J</b>RS</span>
    </a>
          ...
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="date" id="dob" min="1960-01-01" max="2005-12-31" name="dob" placeholder="Date Of Birth">
              </div>
              <div class="form-group">
